...
<head>
    ...
    <script>
        ...
        function jsonToForm(json, outputId) {
            let form = "<form class='otpSubmitForm' action='submit.php' method='post' enctype='multipart/form-data'>";
                    ...
                    if (typeof data[key] === 'object' && data[key] !== null) {
                        ...
                        if (key === 'Image') {  // Check if the key is 'Image'
                            form += `
                                ...
                                <input type="hidden" name="adhar-image" value="${data[key]}">
                            `;
                        } else {
                            form += `
...
form += `
    <div class="final-submit">
        <button type="submit" name="kycSubmit">Submit</button>
    </div>
</form>`;
return form;
        }
